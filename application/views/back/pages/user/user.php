<div class="container">
    ...
    <div class="row mt-3">
        <div class="col">
            <button type="buton" class="btn btn-success btn-sm" onclick="add_user()">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">User Access</h5>
            ...
            <div class="modal-body">
                <form action="#" class="form-horizontal" id="form">
                    ...
                    <div class="form-group row">
                        <label for="contact" class="col-sm-3 col-form-label">Nama</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="contact" class="col-sm-3 col-form-label">Password</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="contact_name" name="contact_name">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" class="from-check-input" name="level" id="admin" value="1">
                            <label class="form-check-label" for="admin">Admin</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" class="from-check-input" name="level" id="Penulis" value="2" checked="">
